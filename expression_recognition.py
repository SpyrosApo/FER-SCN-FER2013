...
class ExpRecognition():
    ...
    def train(self, epoch):
        ...
        train_loss = total_ce_loss/total_num
        accu=100.*correct/total_num
        #print(accu)
        #print(train_loss)
    ...
    def validation(self, validation_path, epoch):
        ...
        print('\tloss: ' + '{:3.6f}'.format(total_loss/total_num))
        validation_loss=total_loss/total_num
        val_accu=100.*correct/total_num
        return validation_loss , val_accu
